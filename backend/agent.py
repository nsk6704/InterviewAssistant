...
The JSON must strictly follow this schema:
{
    ...
    "improvements": ["specific area 1 with actionable advice", "specific area 2 with actionable advice"],
    "technical_score": <integer 0-100>,
    "communication_score": <integer 0-100>,
    "overall_feedback": "A comprehensive 3-4 sentence summary covering: technical performance, communication quality, and key recommendation for improvement. Be specific and actionable."
}
...
- Consider conversation quality: Did they handle confusion well? Were they too chatty? Too brief?
